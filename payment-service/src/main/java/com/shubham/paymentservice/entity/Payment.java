...
public class Payment {
    ...
    public static class PaymentBuilder {
        ...
        private String status = "PAID"; private LocalDateTime createdAt = LocalDateTime.now();
        PaymentBuilder() {}
        ...
        public Payment build() { return new Payment(id, orderId, amount, status, createdAt); }
    }
}
